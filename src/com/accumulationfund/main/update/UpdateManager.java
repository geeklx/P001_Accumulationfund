...
public class UpdateManager {
	public static final String BaoName = "com.liangxiao.accumulationfund";// 设置包名
	public static final String ApkURL = "http://211.142.200.10:8082/upload/accumulationfund/version.xml";// 设置服务器更新包地址
	/* 下载中 */
			...
			public void run() {
				...
				try {
					if (isUpdate() != null) {
						...
						Log.d("消息", "已是最新版本");
						Looper.prepare();
						Toast.makeText(mContext, "已是最新版本", 2).show();
						Looper.loop();
					}
