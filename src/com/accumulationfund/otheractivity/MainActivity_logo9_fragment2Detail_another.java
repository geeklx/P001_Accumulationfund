...
public class MainActivity_logo9_fragment2Detail_another extends Activity
	...
	private void initLayout() {
		handler = new myToast(MainActivity_logo9_fragment2Detail_another.this);
	...
	public void onClick(View v) {
		...
		case R.id.btn_msg_d2:
			...
			Intent intent = new Intent(
					MainActivity_logo9_fragment2Detail_another.this,
