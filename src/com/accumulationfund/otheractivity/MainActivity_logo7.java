...
public class MainActivity_logo7 extends Activity implements OnClickListener {
	...
	private void initView() {
		...
		tv_middle.setText(getResources().getString(R.string.af_logo_7_GuideTo));
