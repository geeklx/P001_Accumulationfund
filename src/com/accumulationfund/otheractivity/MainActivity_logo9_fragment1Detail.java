...
public class MainActivity_logo9_fragment1Detail extends Activity implements
		OnClickListener {
	// 公共
	...
	private void getResult(String arg0) {
		...
		// Toast.makeText(
		// MainActivity_logo9_fragment1Detail.this,
		// "a=" + a.toString() + ",b=" + b.toString() + ",c="
		// + c.toString() + ",d=" + d.toString(), 3).show();
	...
	private void initLayout() {
		handler = new myToast(MainActivity_logo9_fragment1Detail.this);
